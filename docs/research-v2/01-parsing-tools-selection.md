...
> 调研日期：2026-04-08 | 定位：通用技术选型参考 | 场景：PDF 解析（扫描件/图文混排）
> 相关文档：DOCX 场景见 [02](./02-docx-parsing-research.md)、[11](./11-docx-image-text-association.md) | 跨格式 Pipeline 见 [03](./03-multimodal-pipeline-design.md)
